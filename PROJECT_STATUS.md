...
Ninguna en este momento. Última tarea completada: Portal de Finanzas (flujo financiero + cotizaciones + programación de pagos) + departamentos por defecto para todos los colegios. Ver sección 3. Typecheck limpio, verificado con Playwright (3 pestañas, sin errores JS; datos en $0.00 porque el sandbox no llega a la DB real — comportamiento esperado, ver sección 6).
